...
//guardar favoritos ome
saveFavoriteBtn.addEventListener("click", function () {
//si no hay favoritos array vacio, obtiene y convierte el que viene como string en format json
  const favoritos = JSON.parse(localStorage.getItem("favoritos")) || []; 

  favoritos.push({
    //hace el push con el nombre y la imagen del pokemon actual
    id: datosPokemonActual.id,
